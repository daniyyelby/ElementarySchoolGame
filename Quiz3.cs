...
namespace WPFAppFirstTry
{
    class Quiz3
    {
        ...
        public Quiz3()
        {
            questions[0, 0] = "What is 1-0?";
            questions[0, 1] = "3";
            questions[0, 2] = "8";
            questions[0, 3] = "2";
            questions[0, 4] = "*1";
            //
            questions[1, 0] = "What is 5-0?";
            questions[1, 1] = "4";
            questions[1, 2] = "*5";
            questions[1, 3] = "2";
            questions[1, 4] = "10";
            //
            questions[2, 0] = "What is 2-0?";
            questions[2, 1] = "*2";
            questions[2, 2] = "1";
            questions[2, 3] = "22";
            questions[2, 4] = "92";
            //
            questions[3, 0] = "What is 8-0?";
            questions[3, 1] = "*8";
            questions[3, 2] = "81";
            questions[3, 3] = "6";
            questions[3, 4] = "7";
            ...
            questions[7, 4] = "*3";
            //
            questions[8, 0] = "What is 9-0?";
            questions[8, 1] = "8";
            questions[8, 2] = "*9";
            questions[8, 3] = "3";
            questions[8, 4] = "10";
            //
            questions[9, 0] = "What is 4-0?";
            questions[9, 1] = "*4";
            questions[9, 2] = "2";
            questions[9, 3] = "3";
            questions[9, 4] = "5";
            //
            questions[10, 0] = "What is 5-0?";
            questions[10, 1] = "3";
            questions[10, 2] = "2";
            questions[10, 3] = "6";
            questions[10, 4] = "*5";
